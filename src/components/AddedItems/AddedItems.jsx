...
//         const newTokenId = responseData.tokenId; // Access tokenId from the response

//         // Send the tokenId to the other frontend
//         await fetch('https://server-server.gofastapi.com/sendTokenId', {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json',
//             },
//             body: JSON.stringify({ tokenId: newTokenId }),
//         });

//         // Add tokenId to the order state or however you want to store it
